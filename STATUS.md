...
| **Accountability is authorship** | "Maintainers may close non-compliant PRs" names who polices the rule, not who owns the work, and does not count. The metric says only "who holds accountability". |
